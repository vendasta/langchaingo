...
Unlike most forks, we replace all imports from `github.com/tmc/langchaingo` to `github.com/tmc/langchaingo`. This eliminates the need for `replace` directives in consuming services, but creates massive merge conflicts when syncing upstream.
...
- Fork repository: https://github.com/tmc/langchaingo
